...
### So from the outputs we can infer that the p-value is 0.2135 (slopeDicrepancy) (greater than 0.05) which is not strong enough against the null hypothesis. Also, the p-value is 0.22 (correlationDiscrepancy) (greater than 0.05) which is noy strong enough against the null hypothesis and the correlation cofficient must be a non-zero. 
...
### Since Z is a lurking variable for the above problem, it is clear that it has a fixed value(hyperplane)
